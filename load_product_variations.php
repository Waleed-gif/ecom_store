            ...
            <script>
                $(document).ready(function() {
                    ...
                    ?>
                            ...
                            var product_price = "Product Price : $<?php echo $variation_product_price; ?>";

                        <?php } else { ?>

                            var product_price = "Product Price : <del> $<?php echo $variation_product_price; ?> </del><br>";

                            product_price += "Product Sale Price : $<?php echo $variation_product_psp_price; ?>";
                        ...
                        ?>
                            ...
                            var product_price = "Bundle Price : $<?php echo $variation_product_price; ?>";

                        <?php } else { ?>

                            var product_price = "Bundle Price : <del> $<?php echo $variation_product_price; ?> </del><br>";

                            product_price += "Bundle Sale Price : $<?php echo $variation_product_psp_price; ?>";
