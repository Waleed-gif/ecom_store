        ...
        <div class="container">
            ...
            <section>
                <div class="col-xs-12 col-md-12 col-sm-12" 
                    style="background-image: url(images/cart.png); height: 250px;margin-top: -20px">
            ...
            <div class="col-sm-12 col-md-12 col-xs-12" style="background-color: white;padding-top: 30px;padding-bottom: 30px;font-size: 12px">
                <div class="col-xs-12 col-md-12 col-sm-12">
                ...
                <!-- col-md-9 Starts -->
                    ...
                    <div style="  min-height: 550px;border : solid 1px  #e7e4e4; border-radius : 5px;padding: 20px;margin-bottom: 30px">
                        <!-- box Starts -->
                        ...
                        <form action="cart.php" method="post" enctype="multipart-form-data">
                            ...
                            <p style="font-size: 28px;font-weight: bold;">Shopping
                           <span style="color: red;font-size: 28px;font-weight: bold">Cart</p>
                           </span>
                            ...
                            <div class="table-responsive" style="margin-top: 40px">
                                ...
                                <table class="table ">
                                    ...
                                    <tbody class="text-muted" id="cart-products-tbody">
                                        <!-- tbody Starts -->
                                        ...
                                        ?>
                                                ...
                                                <tr style="padding-top: 20px">
                                                    ...
                                                    <td width="350">
                                                        ...
                                                        <a style="font-size: 14px;color: #777;font-weight: bold;" href="<?php echo $product_url; ?>" target="blank"> <?php echo $product_title; ?> </a>

                                                        <p class="cart-product-meta" style="font-size: 12px;margin-top: 10px">
                                                        ...
                                                        <p style="font-size: 12px;margin-top:8px;"> <strong> Sold by: </strong> <?php echo $vendor_name; ?> </p>
                                    ...
                                    <tfoot class="text-muted">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-muted" colspan="5"> Total </th>
                                ...
                                <div class="form-inline pull-right col-md-12" style="margin-top: 2%;padding: 0px">
                                    ...
                                    <section class="col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <label class="text-muted">Coupon Code</label>   

                                        </div><!-- form-group Ends -->
                                        <br>

                                        <input type="text" name="code" class="form-control" style="height: 45px">
                                        <input class="btn btn-primary"  type="submit"  style="height: 45px" name="apply_coupon" value="Apply">
                                    </section>

                                    <section class="col-sm-12 col-xs-12 col-md-6" style="padding-top: 20px" class="pull-right">
                                        <div class="pull-right">
                                    <!-- pull-right Starts -->

                                        <button style="height: 45px;padding-top: 5px;margin-right: 10px" class="btn btn-default" type="submit" name="update" value="Update Cart">
                            ...
                            <div class="box-footer" style="margin-top: 2%;;padding-bottom: 60px">
                                <!-- box-footer Starts -->

                                <div class="pull-left">
                                    <!-- pull-left Starts -->

                                    <a href="index.php" style="color: red;border: none;height: 50px;padding-top: 15px" class="btn btn-default">
                        ...
                        if ($code == "") {
                            ...
                            if ($check_coupons == 1) {
                                ...
                                if ($coupon_limit == $coupon_used) {
                                    ...
                                    echo "<script>('Your Coupon Code Has Been Expired')</script>";
                                } else {
                            ...
                            echo `<div class="alert alert-danger"><!-- alert alert-danger Starts -->

                            <strong class="text-muted"> Warning! </strong> <span class="text-muted">Please Confirm Your Email and if you have not received your confirmation email</span>
            ...
            <div class="col-md-3">
                ...
                <div style="border : solid 1px  #e7e4e4;border-radius: 5px;padding: 15px" id="order-summary">
                    <!-- box Starts -->
                        ...
                        <table class="table">
                            ...
                            <tbody id="cart-summary-tbody">
                                ...
                                <tr style="font-size: 12px;border: none;">
                                    ...
                                    <td style="padding-top: 20px;padding-bottom: 20px;"> Order Subtotal: </td>

                                    <th style="padding-top: 20px;padding-bottom: 20px"> $<?php echo $total; ?>.00 </th>
                                ...
                                <?php if (count($physical_products) > 0) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <th style="padding-top: 20px;font-size: 12px" colspan="2">

                                            <p class="  text-muted" style="text-align: center;"> Cart Total Weight: <?php echo array_sum($total_weight); ?> Kg </p>
                                            <br>

                                            <p class=" text-muted"> <i style="padding: 15px ; text-align: center;" class="fa fa-truck"></i> Shipping: </p>

                                            <ul class="shipping-ul-list list-unstyled text-muted" style="font-size: 12px;text-align: justify;font-weight: normal;line-height: 20px">
                                                ...
                                                ?>
                                                            ...
                                                            <div style="margin-top: 30px" class="shipping-vendor-header"> <?php echo $vendor_name; ?> Shipping: </div>
...
";
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top: 30px;padding-bottom: 30px">Tax:</td>

                                    <th style="padding-top: 30px;padding-bottom: 30px">$0.00</th>
                                ...
                                <tr class="total">
                                    ...
                                    <?php if (count($physical_products) > 0) { ?>
                                        ...
                                        <th style="padding-top: 30px" class="total-cart-price">$<?php echo $total_cart_price; ?>.00</th>

                                    <?php } else { ?>

                                        <th style="padding-top: 30px" class="total-cart-price">$<?php echo $total; ?>.00</th>
                         ...
                         <a href="checkout.php" style="width: 100%;height: 50px;padding-top: 15px" class="btn btn-primary">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="background-color: white;margin-bottom: 50px;margin-top: 30px">
                <!-- col-md-3 col-sm-6 Starts -->
                    <div style="margin-left: 30px;padding-top: 40px;">
                        <p style="font-size: 28px;font-weight: bold;">You Would Also
                       <span style="color: red;font-size: 28px;font-weight: bold">Like These</p>
                       </span>
...
<div  style = 'font-size: 14px;padding-left: 30px' class = 'text-muted'>


<hr>

<h5  ><a style = ' text-decoration: none; color: #777;margin-bottom: 30px' href='$pro_url' >$pro_title</a></h5>
...
<a style = ' width:40%' href='$pro_url' class='btn btn-default' >View details</a>

&nbsp&nbsp

<a style = ' width:40%' href='$pro_url' class='btn btn-primary'>
