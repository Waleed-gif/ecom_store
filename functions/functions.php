...
$outofstock_label = "<a class='label sale' href='#' >

				<div class='thelabel'>Out of Stock</div>
...
<div class='col-md-4 col-sm-6 col-xs-6 single' >
...
echo "
	...
	<div class='col-md-4 col-sm-6 col-xs-6 center-responsive' >
						...
						<img style = 'max-height : 260px; min-height : 200px' src='admin_area/product_images/$pro_img1' class='product-img' >
						...
						<p  ><a class=' text-muted' style=' text-decoration: none; color: #777;margin-bottom: 30px;text-align:justify;font-weight : bold' href='$pro_url' >$pro_title</a></p>

						<p class='text-muted' style = 'color : red'> $product_price $product_psp_price </p>
