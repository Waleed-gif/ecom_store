...
<h3 class="text-muted"> Please enter your email address. You will receive a link to create a new password via email. </h3>
...
<input type="text" class="form-control" style="height: 50px;margin-top: 60px; width: 96%" name="c_email" placeholder="Enter Your Email">

<br>

<input type="submit" name="forgot_pass" style="height: 50px; width: 40%;margin-top: 30px;margin-bottom: 40px" class="btn btn-primary" value="Submit">
