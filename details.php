		...
		<div class="container" ><!-- container Starts -->
			...
			<section>
		        <div class="col-xs-12 col-md-12 col-sm-12" 
		            style="background-image: url(images/detail.png); height: 250px;margin-top: -20px;">
			...
			<!--- Second End breadcrumb start -->


			<!-- Third Section -->
			<div class="col-xs-12 col-md-12 col-sm-12" style="background-color: white;padding: 30px;" >
				
				<center>
					<div class="text-muted" style="margin-bottom: 30px;text-align: justify;padding-left: 145px">
				...
				<div class="col-md-8 col-sm-12 col-xs-12" style="padding: 0px">
					...
					<!--	Small five images --->
					<div class="row col-md-3 col-sm-3 col-xs-12" style="margin-bottom: 30px"  id="thumbs" >

						
						<div class="col-xs-6 col-sm-12 col-md-12"  style="margin-bottom: 20px" ><!-- col-xs-4 Starts -->

							<a href="#" class="thumb" >

							<img style="height: 100px;width: 100px" src="admin_area/product_images/<?php echo $pro_img1; ?>" class="img-responsive" >
						...
						<div class="col-xs-6 col-sm-12 col-md-12" style="margin-bottom: 20px"  ><!-- col-xs-4 Starts -->
							...
							<img style="height: 100px;width: 100px"  src="admin_area/product_images/<?php echo $pro_img2; ?>" class="img-responsive" >
						...
						<div class="col-xs-6 col-sm-12 col-md-12" style="margin-bottom: 20px" ><!-- col-xs-4 Starts -->
							...
							<img style="height: 100px;width: 100px"  src="admin_area/product_images/<?php echo $pro_img3; ?>" class="img-responsive" >
					...
					<!--	End Small five images --->

					<!--- Big Image start -->
					<div class="col-md-9 col-sm-9 col-xs-12" style="margin-bottom: 30px;padding: 0px">

						<!-- mainImage Starts -->
						<div style="border: solid 1px #e7e4e4; border-radius: 5px;padding: 2px;height: 400px">

							<center>
								<img  style="max-height: 395px;max-width: 395px"  src="admin_area/product_images/<?php echo $pro_img1; ?>" >
							</center>
				...
				<div class="col-md-4 col-sm-12 col-xs-12" style="border: solid 1px #e7e4e4; border-radius: 5px;padding: 30px;min-height: 400px"><!-- col-sm-6 Starts -->
					...
					<div> 
						...
						<form action="" method="post" class="form-horizontal" style="font-size: 14px">
								...
								<?php 
									...
									while($row_product_attributes = mysqli_fetch_array($run_product_attributes))
									{
										...
										?>
											...
											<div class="form-group" style=" padding-right: 30px;padding-left: 20px"><!-- form-group Starts -->

												<label class="col-lg-4 col-md-3 text-muted" style=" font-weight: normal;"> <?php echo $attribute_name; ?> 
												</label>

												<div class="col-lg-8 col-md-9"><!-- col-lg-6 col-md-9 Starts -->
							...
							<!-- form-group Starts -->
							<div class="text-muted" style="margin-top: 40px;padding-left: 5px;padding-right: 20px">


								<?php if($status == "product"){ ?>

								<label style="font-weight: normal;" class="col-lg-4 col-md-3 " > Quantity </label>

								<?php }elseif($status == "bundle"){ ?>

								<label style="font-weight: normal;" class="col-lg-4 col-md-3 control-label" >Bundle Quantity </label>
							...
							<div class="col-md-12 col-sm-12" style="margin-top: 20px;margin-left: -5px">
								...
								<div class="col-md-12 col-sm-12" >
									...
									if($pro_type == "physical_product" or $pro_type == "digital_product")
									{
										...
										if($status == "product")
										{
											...
											if($pro_psp_price == 0)
											{
												...
												<p class='text-muted' style = 'font-size: 16px;padding-left:20px font-weight:bold'>
											...
											else
											{
												...
												<p class='text-muted' style = ';padding-left:20px font-weight:bold'>

												Product Price : <del> $$pro_price </del>

												 

												</p>

												<p class='text-muted' style = 'margin-top20px;margin-bottom:30px;padding-left:20px font-weight:bold'>
									...
									echo " <p class='text-muted' style = 'font-size: 16px;padding-left:20px font-weight:bold'> ";
								...
								<div class="col-md-12 col-sm-12">
									...
									<h5 style="color: red;margin-bottom: 30px;margin-top: 20px">
										...
										<p style="color: red"><?php echo $stock_quantity; ?> items in stock </p>
							...
							<p class="text-center buttons" style="margin-top: 30px;margin-bottom: 30px"><!-- text-center buttons Starts -->
							<button class="btn btn-primary" style="height: 50px;width: 100%;margin-bottom: 20px" type="submit" name="add_wishlist">

							<i class="fa fa-heart"></i> Add to Wishlist

							</button>
							<button class="btn btn-primary" style="height: 50px;width: 100%;margin-bottom: 20px" type="submit" name="add_cart">
			...
			<!-- box Starts -->
			<div class=" col-md-12  col-sm-12 col-xs-12" style="margin-top: 30px;background-color: white;padding: 30px;margin-bottom: 30px" id="details">
				...
				<ul class="nav nav-pills" style="margin-bottom:15px;">
					...
					<li class="active"><!-- li Starts -->
						...
						<a style="margin-top: 30px;margin-bottom: 30px"  class="tab" href="#description" data-toggle="tab"><!-- btn btn-primary Starts -->
					...
					<li><!-- li Starts -->
						...
						<a style="margin-top: 30px;margin-bottom: 30px" class="tab" href="#features" data-toggle="tab"><!-- btn btn-primary Starts -->
					...
					<li><!-- li Starts -->
						...
						<a  style="margin-top: 30px;margin-bottom: 30px"  class="tab" href="#video" data-toggle="tab"><!-- btn btn-primary Starts -->
					...
					<li><!-- li Starts -->
						...
						<a style="margin-top: 30px;margin-bottom: 30px"  class="tab" href="#vendor_info" data-toggle="tab"><!-- btn btn-primary Starts -->
					...
					<li><!-- li Starts -->
						...
						<a style="margin-top: 30px;margin-bottom: 30px"  class="tab" href="#reviews" data-toggle="tab"><!-- btn btn-primary Starts -->
				...
				<div class="text-muted tab-content" style="padding-top: 20px;margin-top:7px;text-align: justify;padding-right: 20px;padding-left: 20px">
					
					<!-- description tab-pane fade in active Starts -->
					<div id="description" class="tab-pane fade in active text-muted"  >


						<p style="font-size: 18px;font-weight: bold;">Product
					    <span style="color: red;font-size: 18px;font-weight: bold">Description</p>
					    </span>
						...
						<?php echo$pro_desc; ?>
							...
							<p style="font-size: 18px;font-weight: bold;margin-top: 30px">Additional
						    <span style="color: red;font-size: 18px;font-weight: bold">information</p>
						    </span>
						    <img src="images/line.png" style="margin-bottom: 30px">
							...
							<table class="table-striped" style="width: 100%;"> 
								...
								<tbody>
									...
									<td  style="padding-top: 30px; padding-bottom: 30px; padding-left: 20px"> <strong><?php echo $attribute_name; ?></strong> </td>

									<td style="padding-top: 30px; padding-bottom: 30px ;padding-left: 20px"> <?php echo $attribute_values; ?> </td>
					...
					<div id="features" class="tab-pane fade in"  ><!-- features tab-pane fade in  Starts -->
						...
						<p style="font-size: 18px;font-weight: bold;">Product
					    <span style="color: red;font-size: 18px;font-weight: bold">Features</p>
					    </span>
					    <img src="images/line.png" style="margin-bottom: 30px">
					...
					<div id="video" class="tab-pane fade in" style="margin-top:7px;" ><!-- video tab-pane fade in Starts -->
						...
						<p style="font-size: 18px;font-weight: bold;">Product
					    <span style="color: red;font-size: 18px;font-weight: bold">Sounds And Videos</p>
					    </span>
					    <img src="images/line.png" style="margin-bottom: 30px">
					    <br>

						<center>
							<video controls="" width="70%" height="70%"><?php echo $pro_video; ?></video>
						</center>
					...
					<div id="vendor_info" class="tab-pane fade in"><!-- vendor_info tab-pane fade in Starts -->
						...
						<p style="font-size: 18px;font-weight: bold;">Vendor
					    <span style="color: red;font-size: 18px;font-weight: bold">Information</p>
					    </span>
					    <img src="images/line.png" style="margin-bottom: 30px">

						<p> <strong> Store Name: </strong> <?php echo $store_name; ?> 
						</p>
					...
					<div id="reviews" class="tab-pane fade in" style="margin-top:7px;" ><!-- reviews tab-pane fade in Starts -->
						...
						<div class="product-reviews" id="write-a-review"><!-- product-reviews Starts -->
							...
							<section class="reviews-summary row"><!-- reviews-summary row Starts -->
								...
								<section class="col-md-12 col-xs-12 col-sm-12" style="margin-top: 10px;margin-bottom: 30px;border: solid 1px #e7e4e4;border-radius: 5px;">
								
								<section class="col-md-8 col-sm-12 col-xs-12" style="
								    border-radius: 5px;padding: 30px">
									<article class="avg-rating col-md-6 col-xs-12 col-sm-6"><!-- avg-rating Starts -->

										<header style="margin-bottom: 10px"> 
											<p style="font-size: 18px;font-weight: bold;margin-left: -95px">Average
										        <span style="color: red;font-size: 18px;font-weight: bold">Rating</p>
										        </span>
										          <img src="images/line.png" style="margin-bottom: 30px">
										...
										<span style="padding: 10px;border-radius: 5px;color: white"><?php printf("%.1f", $product_rating); ?></span> 
									...
									<article  class="rating-bars col-md-6 col-xs-12 col-sm-6" style="margin-top: 70px"><!-- rating-bars Starts -->
								...
								<article class="write-review col-md-4 col-sm-12 col-sm-12" style="
								    border-radius: 5px;padding: 30px" ><!-- write-review Starts -->

									<header style="color: red"> Have you used this product before? </header>
									...
									<button style="background-color: red;border: none; height: 50px;color: white;border-radius: 5px;width: 100%;font-size: 18px;margin-top: 40px;margin-bottom: 15px" type="submit" name="submit" class="btn">
									Write A Review
									</button>
								...
								<div class="col-md-12 col-sm-12 col-xs-12" style="border: solid 1px #e7e4e4;border-radius: 5px;padding: 30px">
									
									<div class="col-md-9 col-sm-12" style="margin-bottom: 20px;margin-top: 5px">
										 
										<p style="font-size: 18px;font-weight: bold;">All Product
								        <span style="color: red;font-size: 18px;font-weight: bold">Reviews</p>
								        </span>
								          <img src="images/line.png" style="margin-bottom: 30px">
									</div>
									<div class="col-md-3 col-sm-12">
										...
										<div class="dropdown" style="margin-top: 20px;float: right;"><!--- dropdown float-right Starts -->
									...
									<div class="clearfix"></div>
										...
										<ul id="all" class=" reviews-list"><!-- all reviews-list Starts -->
											...
											<h5 align="center"> This Product Has No Reivew, Become First To Write A Reivew. </h5>
										...
										<ul id="good" class="reviews-list"><!-- good reviews-list Starts -->
											...
											<h5  > There Is Currently No Positive Review Of This Product. </h5>
			...
			<div id="row same-height-row flex-wrap" class="col-xs-12 col-sm-12 col-md-12" 
				style="padding: 40px;background-color: white">
				<center>
					<p style="font-size: 28px;font-weight: bold;">You Also
			        <span style="color: red;font-size: 28px;font-weight: bold">Like These Product</p>
			        </span>
			   ...
			   <br>
				...
				while($row_products = mysqli_fetch_array($run_products)) 
				{
					...
					if(($product_type != "variable_product" and $stock_status == "outofstock") or 
					...
					echo "
						...
						<div class='col-md-4 col-sm-6 center-responsive' style ='margin-bottom:20px'>
						...
						<div class='text' style='padding:20px;margin-top:30px'>


						<h5  ><a class=' text-muted' style=' text-decoration: none; color: #777;margin-bottom: 30px' href='$pro_url' >$pro_title</a></h5>

						<p class='star-rating text-muted'> $product_rating_stars </p>

						<p class='text-muted'> $product_price $product_psp_price </p>



						<p >Sold by: $manufacturer_name </p>
						...
						<a href='$pro_url' class='btn btn-primary'  style='height:40px;width:96%;padding-top:10px'>
				...
				<h5 class='product-title'><a  style=' text-decoration: none; color: #777;margin-bottom: 30px' href='$pro_url' >$pro_title</a></h5>

				<p class='star-rating text-muted> $product_rating_stars </p>

				<p class='price text-muted' style = 'font-size:14px;'> $product_price $product_psp_price </p>

				<p class='buttons'  style='margin-top:30px'>

				<h5 class = 'text-muted' style = 'margin-top: -20px;margin-bottom : 30px'> Sold by: $manufacturer_name </h5>


				<center>

				
				<a href='$pro_url' style = 'width : 40%'  class='btn btn-primary'>
