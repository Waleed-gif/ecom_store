...
<input type="text" name="billing_first_name" style="height: 50px" class="form-control" required value="<?php echo $billing_first_name; ?>">
...
<input type="text" name="billing_last_name" style="height: 50px" class="form-control" required value="<?php echo $billing_last_name; ?>">
...
<select name="billing_country" style="height: 50px" class="form-control">
...
<input type="text" name="billing_address_1" style="height: 50px" class="form-control" required value="<?php echo $billing_address_1; ?>">
...
<input type="text" name="billing_address_2" style="height: 50px" class="form-control" required value="<?php echo $billing_address_2; ?>">
...
<label class="text-muted"> State / County : </label>

<input type="text" name="billing_state" style="height: 50px" class="form-control" required value="<?php echo $billing_state; ?>">
...
<label class="text-muted"> Town / City : </label>

<input type="text" name="billing_city" style="height: 50px" class="form-control" required value="<?php echo $billing_city; ?>">
...
<label class="text-muted"> Postcode / ZIP : </label>

<input type="text" name="billing_postcode" style="height: 50px" class="form-control" required value="<?php echo $billing_postcode; ?>">

</div><!-- form-group Ends -->

<div class="form-group"><!-- form-group Starts -->

<input type="submit" name="update_billing_address" style="height: 50px;margin-top: 20px;margin-bottom: 30px" value="Update Billing Address" class="form-control btn btn-success">

</div><!-- form-group Ends -->

</form>

<h2 class="text-muted"> Shipping Address </h2>
...
<input type="text" name="shipping_first_name" class="form-control" style="height: 50px" required value="<?php echo $shipping_first_name; ?>">
...
<input type="text" name="shipping_last_name" class="form-control" style="height: 50px" required value="<?php echo $shipping_last_name; ?>">
...
<select name="shipping_country" style="height: 50px" class="form-control">
...
<input type="text" name="shipping_address_1" style="height: 50px" class="form-control" required value="<?php echo $shipping_address_1; ?>">
...
<input type="text" name="shipping_address_2"style="height: 50px" class="form-control" required value="<?php echo $shipping_address_2; ?>">
...
<input type="text" name="shipping_state" style="height: 50px" class="form-control" required value="<?php echo $shipping_state; ?>">
...
<input type="text" name="shipping_city" style="height: 50px" class="form-control" required value="<?php echo $shipping_city; ?>">
...
<input type="text" name="shipping_postcode" style="height: 50px" class="form-control" required value="<?php echo $shipping_postcode; ?>">

</div><!-- form-group Ends -->

<div class="form-group"><!-- form-group Starts -->

<input type="submit" name="update_shipping_address"  style="height: 50px ; margin-top: 20px;margin-bottom: 30px" value="Update Shipping Address" class="form-control btn btn-success">
